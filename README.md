# Jacobian Conjecture — Canonical Lane Mathlib
...
```bash
git clone https://github.com/HautevilleHouse/jacobian-conjecture-canonical-lane-mathlib.git
cd jacobian-conjecture-canonical-lane-mathlib
lake exe
lake build
```

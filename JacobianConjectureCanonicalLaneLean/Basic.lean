/-!
# jacobian-conjecture-canonical-lane Lean migration boundary
...
`JacobianConjectureCanonicalLaneLean/SourcePackage.lean`.
...
def sourceRepository : String := "jacobian-conjecture-canonical-lane"
def sourceUrl : String := "https://github.com/HautevilleHouse/jacobian-conjecture-canonical-lane"
def sourceDescription : String := "Canonical-lane closure package for the Jacobian Conjecture: admissible-class formulation, projection gates, local-to-global bridge, and carried remainder."
def sourceClassification : String := "abstract_math_theorem_repo"
def sourceTopics : List String := ["algebraic-geometry", "commutative-algebra", "jacobian-conjecture", "mathematical-proof", "polynomial-maps", "reproducibility", "polynomial-automorphisms", "canonical-lane", "local-to-global", "manifold-constrained"]
